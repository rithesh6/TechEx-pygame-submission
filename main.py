...
def mainGame():
    ...
    while True:
        ...
        SCREEN.blit(GAME_SPRITES['base'], (basex, GROUNDY))
        SCREEN.blit(GAME_SPRITES['player'], (playerx, playery))
        nowDIG = [int(x) for x in list(str(points))]
        width = 0 
        for digit in nowDIG:
...
pygame.display.set_caption('Flappy Bird by Rithesh')
...
GAME_SOUNDS['swooshing'] = pygame.mixer.Sound('music/sfx_swooshing.wav')
